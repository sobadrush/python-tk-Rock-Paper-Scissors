...
class GAMING_INTERFACE:
    ...
    def run(self):
        ...
        # 視窗大小
        root.geometry(f'{self.GAME_WIDTH}x{self.GAME_HEIGHT}')
        # 視窗標題
        root.title('剪刀石頭布')
        # 固定視窗大小
        ...
        # 放置電腦的畫面
        self.robot_frame.place( x=self.GAME_WIDTH*0.5, y=self.GAME_HEIGHT*0.2 )
        ####### END #######
    ...
    def __set_robot_frame(self,root):
        ...
        # 放置電腦的石頭
        robot_stone_label.place( x=360, y=400, anchor='center' )
